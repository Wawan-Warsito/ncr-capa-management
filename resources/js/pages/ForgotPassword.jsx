...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setStatus(response.data.message || response.data.status || 'Password reset link sent!');
                    ...
                    <div className="rounded-md bg-green-50 p-4">
                        <div className="flex">
                            <div className="ml-3">
                                ...
                                {resetUrl && (
                                    <div className="mt-2 text-sm text-green-800 break-all">
                                        <a href={resetUrl} className="underline" target="_blank" rel="noreferrer">
                                            Open reset link
                                        </a>
                                    </div>
                                )}
