...
class DeadlineReminderNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                    ->subject("Deadline Reminder: {$this->type} {$number}")
                    ->line("This is a reminder that the following {$this->type} is due soon.")
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'number' => $number,
            'message' => "Deadline reminder for {$this->type} {$number}.",
        ];
    }
}
